...
def adamw_step_fused(p, grad, exp_avg, exp_avg_sq, step_t, lr_t, beta1_t, beta2_t, eps_t, wd_t):
    # Keep AdamW eager: this function is called over heterogeneous tensor shapes
    # (especially with NOBLE branch params), and forcing a single compiled graph
    # can hit recompile limits on A10.
    p.mul_(1 - lr_t * wd_t)
